<section class="ab-pochemy-mi">
	<div class="container">
		<div class="row">
			<div class="col-md-12 padding-top-col">
				<div class="ab-pochemy-mi-title">
					<span>Почему именно мы</span>
				</div>
			</div>
			<div class="col-md-6 padding-top-col">
			...
			<div class="col-md-4">
				<div class="ab-medal">
					<img src="img/ab-medal2.png" alt="">
				</div>
			</div>
			<div class="col-md-3">
				<div class="ab-medal">
					<img src="img/ab-medal3.png" alt="">
				</div>
			</div>
			<div class="col-md-1">
